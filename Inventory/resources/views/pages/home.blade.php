    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header01">
                ...
                <div><a class="btn mt-3 bg-gradient-warning text-dark" href="{{ url('/userLogin') }}">Start Sale</a></div>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="{{ asset('/images/bil.jpg') }}" alt="">
                        <h5>Bill Gates</h5>
                        <p class="text-muted mb-4">MD &amp; Partner</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="{{ asset('/images/man.jpeg') }}" alt="">
                        <h5>Ankon Chowdhury</h5>
                        <p class="text-muted mb-4">CEO &amp; Founder</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="{{ asset('/images/elon.jpg') }}" alt="">
                        <h5>Elon Musk</h5>
                        <p class="text-muted mb-4">COO &amp; Founder</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="{{ asset('/images/jeff.jpg') }}" alt="">
                        <h5>Jeff Bezos</h5>
                        <p class="text-muted mb-4">CFO &amp; Business Partner</p>
                    </div>
                </div>
            </div>
        </div>
